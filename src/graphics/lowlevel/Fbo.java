...
public class Fbo {
	...
	private Texture colourBufferTexture;
	...
	public void unbindFrameBuffer() {
		...
		GL11.glViewport(0, 0, GameState.WIDTH, GameState.HEIGHT);
	}
	...
	public int getColourTexture() {
		...
		//return new Texture(width, height, colourBuffer, GL11.GL_TEXTURE_2D);
	}
